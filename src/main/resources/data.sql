...
INSERT INTO users (id, firstName, lastName, email, password, verified)
VALUES
(1111, 'Tyrion', 'Lannister', 'tyrion.lannister@mail.univ.ca', 'password', true),
(2222, 'Cersei', 'Lannister', 'cersei.lannister@mail.univ.ca', 'password', true),
(3333, 'Jaime', 'Lannister', 'jaime.lannister@mail.univ.ca', 'password', true),
(4444, 'Daenerys', 'Targaryen', 'jaime.targaryen@mail.univ.ca', 'password', true),
(5555, 'Jon', 'Snow', 'jon.snow@mail.univ.ca', 'password', true);
...
INSERT INTO users (id, firstName, lastName, email, password, verified)
VALUES
(6666, 'Varys', 'Varys', 'varys@mail.univ.ca', 'password', true);
